...
def run_test_problem1b():
    ...
    # Test 3:
    expected = 18  # This is APPROXIMATELY the correct answer.
    answer = problem1b(8, 10)
    print()
...
def problem1c(n):
    ...
    for k in range(n - 1):
        if is_prime(k + 2):
            product_of = product_of * (k + 2)

    return sum_of_digits(product_of)
